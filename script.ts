...
function displayWeather(data) {
    const tempDivInfo = document.getElementById('temp-div') as HTMLDivElement;
    const weatherInfoDiv = document.getElementById('weather-info') as HTMLDivElement;
    const weatherIcon = document.getElementById('weather-icon') as HTMLImageElement;
    const hourlyForecastDiv = document.getElementById('hourly-forecast') as HTMLDivElement;
...
function displayHourlyForecast(hourlyData) {
    const hourlyForecastDiv = document.getElementById('hourly-forecast') as HTMLDivElement | null;
